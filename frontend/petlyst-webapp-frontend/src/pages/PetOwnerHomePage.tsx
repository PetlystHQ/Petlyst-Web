...
const PetOwnerHomePage: React.FC = () => {
  ...
  // Handle city card click - özel olarak şehirlere göre filtreleme yap
  const handleCityCardClick = (city: string) => {
    ...
    params.set('veterinarian', ''); // Sadece klinikleri göster (veterinarian parametresi boş olduğunda klinikler gösterilir)
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* City Cards Section */}
      <div className="mb-16">
        <h2 className="text-2xl font-semibold text-center mb-8">Popular Cities</h2>
      ...
      {/* Footer - Simplified */}
      <footer className="bg-[#458AB5] bg-opacity-90 text-white mt-16 rounded-t-xl shadow-md">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-blue-50 hover:text-white hover:underline transition-colors">
                Privacy Policy
              </a>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/petbilir/" target="_blank" rel="noopener noreferrer" className="text-blue-50 hover:text-white transition-colors">
