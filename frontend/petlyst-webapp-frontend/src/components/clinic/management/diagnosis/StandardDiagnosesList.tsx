  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 border border-gray-100">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold">Diagnoses Templates</h2>
        <button
          onClick={handleAddNew}
          className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          <FaPlus className="mr-2" />
          New Diagnosis Template
        </button>
      </div>
      ...
      {!loading && filteredDiagnoses.length === 0 && (
        <div className="bg-white p-6 text-center rounded-lg border border-dashed border-gray-300">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No diagnosis templates found</h3>
          <p className="mt-1 text-sm text-gray-500">
            {searchTerm || speciesFilter 
              ? 'Try adjusting your search or filter criteria.'
              : 'Get started by creating a new diagnosis template.'}
          </p>
          <div className="mt-6">
            <button
              onClick={handleAddNew}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-xl">
            <div className="flex items-center text-red-600 mb-4">
              ...
              <h3 className="text-xl font-bold">Delete Diagnosis Template</h3>
            </div>
            
            <p className="text-gray-700 mb-6">
              Are you sure you want to delete this diagnosis template? This may affect diagnoses that use this code.
            </p>
