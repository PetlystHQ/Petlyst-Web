...
const DiagnosisList: React.FC<DiagnosisListProps> = ({ 
  ...
  const handleFilterChange = <K extends keyof DiagnosisFilters>(key: K, value: DiagnosisFilters[K]) => {
    setLocalFilters({
      ...localFilters,
      [key]: value
    });
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFilterChange('diagnosis_type', (e.target.value || undefined) as DiagnosisFilters['diagnosis_type'])}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFilterChange('severity', (e.target.value || undefined) as DiagnosisFilters['severity'])}
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                >
